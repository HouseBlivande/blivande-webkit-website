...
export default {
  ...
  methods: {
    ...
    remoteConfig(configId) {
      axios
        .get("https://forum.blivande.com/t/" + configId + ".json")
        .then(({ data }) => {
    ...
    applyStyle(element, property) {
      ...
      if (
        this.globalStyle &&
        this.globalStyle[element] &&
        this.globalStyle[element][property]
      ) {
      ...
      if (
        this.sectionStyle &&
        this.sectionStyle[element] &&
        this.sectionStyle[element][property]
      ) {
    ...
    heroStyle(style) {
      ...
      var backgroundUrl =
        style.background.url[index] || style.background.url[0];
      var backgroundColor =
        style.background.color[index] || style.background.color[0];
      var backgroundSize =
        style.background.size[index] || style.background.size[0];
      var backgroundRepeat =
        style.background.repeat[index] || style.background.repeat[0];
      var containerPadding =
        style.container.padding[index] || style.container.padding[0];
      return {
    ...
    elementClass(array, element) {
      ...
      if (array) {
        ...
        if (
          index !== 0 &&
          this.globalStyle[element] &&
          this.globalStyle[element]["class"]
        ) {
    ...
    customUiStyle(style, ui) {
      if (style && style[ui]) {
        ...
        for (var propName in style[ui]) {
          if (
            style[ui][propName] !== null ||
            style[ui][propName] !== undefined ||
            style[ui][propName] !== "" ||
            style[ui][propName] !== ""
          ) {
