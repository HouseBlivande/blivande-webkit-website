<template>
  <div
    class="section px-5 md:px-0 md:section-md events"
    id="events"
    :style="containerStyle(data.style)"
  >
    <div
      class="flex justify-between items-center px-8 py-4 mx-auto mt-8 mb-6 w-full"
      :style="textStyle('title', data.style)"
      :class="titleClassSize(data.style)"
    >
    ...
    <div v-for="(view, index) in data.views" class="w-full" :key="index">
        ...
        <div class="event_grid_options w-full mb-6">
          <div class="event_search">
            <div
              ...
              :class="{ plainTag: filter.color == null }"
          ...
          <div class="popup">
            <div
              ...
              :class="{ active: popup == 'calendar' }"
              @click="activePopup('calendar')"
            ></div>
            <transition name="fade">
              <div
                class="popup_container calendar_container"
                v-if="popup == 'calendar'"
              >
                <Calendar
                  :dates="dataReverse"
              ...
              <template>
                <div slot="header">
                  ...
                  >
                    ...
                    <span v-if="show('time', view.grid.display)"
      ...
      >
        <template v-slot:item="{ item }">
          ...
          <p
            class="item_date"
            v-if="item.event && show('date', view.list.display)"
          >
            {{ item.event.start | formatDate }}
          </p>
          <p
        ...
        <template v-slot:selected="{ selected }">
          ...
          <div slot="title">
            ...
            <Profile
              ...
              v-if="show('author', view.list.display)"
            />
          </div>
